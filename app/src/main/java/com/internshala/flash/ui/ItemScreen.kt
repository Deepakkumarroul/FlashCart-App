...
fun ItemScreen(flashViewModel: FlashViewModel,
    ...
    LazyVerticalGrid(
        ...
        item(
            ...
            Column {
                Image(painter = painterResource(id = R.drawable._60), contentDescription = "Offer")
                Card (
...
fun ErrorScreen(flashViewModel: FlashViewModel){
    Column (
        ...
        Text(text = "Oops !! Please check your connection or retry after turning your wifi or mobile data",
            modifier = Modifier
                .fillMaxWidth()
                .padding(20.dp),
            textAlign = TextAlign.Center
